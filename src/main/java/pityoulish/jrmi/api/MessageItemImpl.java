...
/**
 * Default implementation of {@link MessageItem}.
 */
public class MessageItemImpl implements MessageItem, Serializable
{
  // should be defined for every serializable class
  private final static long serialVersionUID = 20161014204044L;
   ...
   */
  public MessageItemImpl(String originator, String timestamp, String text)
  {
    if (originator == null)
